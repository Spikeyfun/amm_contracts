module spike_amm::amm_zap {
  ...
  */
  public entry fun zap_in_supra(
    ...
    zap_in_internal(sender, WSUP, amount_in, lp_token, token_amount_out_min);
  }
  ...
  */
  ...
  public entry fun zap_in_supra_rebalancing(
    ...
    zap_in_rebalancing_internal(sender, WSUP, token1_to_zap, supra_amount_in, token1_amount_in, lp_token, token_amount_in_max, token_amount_out_min, is_token0_sold);
  }
